...
for index, image_path in enumerate(tqdm(images)):
    ...
    # if screenCnt is None, skip this image
    if screenCnt is None:
        print(f"Could not find contour for image {image_path}. Skipping...")
        continue
    ...
    cv2.imwrite(f"Scanned{index+1}.jpg", warped)
    os.chdir(cwd)
